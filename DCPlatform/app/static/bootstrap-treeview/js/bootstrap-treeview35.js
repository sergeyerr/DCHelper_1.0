...
;(function ($, window, document, undefined) {
	...
	*/
	...
	Tree.prototype.contextMenuHandler = function (event) {
		...
		this.options.onContextMenu(event, node);
		//alert(node.initId);
	...
	*/
	Tree.prototype.search = function (pattern, options) {
		...
		if (pattern && pattern.length > 0) {
			...
			results = this.findByInitId(pattern, modifier)
	...
	*/
	Tree.prototype.findByInitId = function (pattern, modifier, attribute) {


		var _this = this;
		return $.grep(this.nodes, function (node) {
			var val = _this.getNodeValue(node, 'initId');
